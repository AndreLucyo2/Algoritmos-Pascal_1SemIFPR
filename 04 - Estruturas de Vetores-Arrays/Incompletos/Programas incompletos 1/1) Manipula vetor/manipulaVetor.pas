...
program manipulaVetor;
   ...
   // Declaração de procedures e funcoes
      ...
      begin
            ...
            while (posicao >= 1 ) and (posicao <= tamVetor) do
            begin
               // insira seu código aqui, conforme apropriado
               writeln('   Valor ',posicao,' = ',vetNum[posicao]);     
...
begin
   ...
   imprimeVetor(true);//Chama a procedure que imprime o vetor

   writeln('Imprimindo o vetor do ultimo ao primeiro valor...');
   imprimeVetor(false);//Chama a procedure que imprime o vetor
