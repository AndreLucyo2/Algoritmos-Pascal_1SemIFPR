...
begin
   ...
   //1° Validação:
   if (idMes < 1) or (idMes > 12) then
      begin
         writeln('Data informada invalida, Verifique mes informado');
               ...
               case idMes of //Mes anterior tem 31 dia
                  2,4,6,9,11: 
	               begin 
                     ...
                     if (idDia > 30) then
                        begin
                           writeln('Data informada invalida, o mes so tem 31 dias');
                           writeln('Sistema será encerrado!');
                           exit;
                        end;
                  ...
                  begin
                     ...
                     if ehBissexto = false then
                        begin
                           ...
                           if (idDia > 28) then
                              begin
                                 writeln('Data informada invalida, o mes so tem 28 dias');
                                 writeln('Sistema será encerrado!');
                                 exit;
                              end;
                        ...
                        begin
                           ...
                           if (idDia > 29) then
                              begin
                                 writeln('Data informada invalida, o mes so tem 29 dias');
                                 writeln('Sistema será encerrado!');
                                 exit;
                              end;
